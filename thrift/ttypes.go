...
type ExecutorTaskInfoHelper struct {
	...
	ExecName              string    `thrift:"execName,7" json:"execName"`
	Folder                string    `thrift:"folder,8" json:"folder"`
	ComputationAliasName  string    `thrift:"computationAliasName,9" json:"computationAliasName"`
	ClientArguments       []string  `thrift:"clientArguments,10" json:"clientArguments"`
	EnvironmentExtra      []string  `thrift:"environmentExtra,11" json:"environmentExtra"`
	DockerContainer       string    `thrift:"dockerContainer,12" json:"dockerContainer"`
	Retries               int32     `thrift:"retries,13" json:"retries"`
	Router                *Endpoint `thrift:"router,14" json:"router"`
}
...
var ExecutorTaskInfoHelper_Router_DEFAULT *Endpoint

func (p *ExecutorTaskInfoHelper) GetRouter() *Endpoint {
	if !p.IsSetRouter() {
		return ExecutorTaskInfoHelper_Router_DEFAULT
	}
	return p.Router
}
...
func (p *ExecutorTaskInfoHelper) GetRetries() int32 {
	return p.Retries
}
...
func (p *ExecutorTaskInfoHelper) IsSetRouter() bool {
	return p.Router != nil
}
...
func (p *ExecutorTaskInfoHelper) ReadField14(iprot thrift.TProtocol) error {
	p.Router = &Endpoint{}
	if err := p.Router.Read(iprot); err != nil {
		return fmt.Errorf("%T error reading struct: %s", p.Router, err)
	}
	return nil
}
...
func (p *ExecutorTaskInfoHelper) writeField7(oprot thrift.TProtocol) (err error) {
	if err := oprot.WriteFieldBegin("execName", thrift.STRING, 7); err != nil {
		return fmt.Errorf("%T write field begin error 7:execName: %s", p, err)
	}
	if err := oprot.WriteString(string(p.ExecName)); err != nil {
		return fmt.Errorf("%T.execName (7) field write error: %s", p, err)
	}
	if err := oprot.WriteFieldEnd(); err != nil {
		return fmt.Errorf("%T write field end error 7:execName: %s", p, err)
	}
	return err
}

func (p *ExecutorTaskInfoHelper) writeField8(oprot thrift.TProtocol) (err error) {
	if err := oprot.WriteFieldBegin("folder", thrift.STRING, 8); err != nil {
		return fmt.Errorf("%T write field begin error 8:folder: %s", p, err)
	}
	if err := oprot.WriteString(string(p.Folder)); err != nil {
		return fmt.Errorf("%T.folder (8) field write error: %s", p, err)
	}
	if err := oprot.WriteFieldEnd(); err != nil {
		return fmt.Errorf("%T write field end error 8:folder: %s", p, err)
	}
	return err
}

func (p *ExecutorTaskInfoHelper) writeField9(oprot thrift.TProtocol) (err error) {
	if err := oprot.WriteFieldBegin("computationAliasName", thrift.STRING, 9); err != nil {
		return fmt.Errorf("%T write field begin error 9:computationAliasName: %s", p, err)
	}
	if err := oprot.WriteString(string(p.ComputationAliasName)); err != nil {
		return fmt.Errorf("%T.computationAliasName (9) field write error: %s", p, err)
	}
	if err := oprot.WriteFieldEnd(); err != nil {
		return fmt.Errorf("%T write field end error 9:computationAliasName: %s", p, err)
	}
	return err
}

func (p *ExecutorTaskInfoHelper) writeField10(oprot thrift.TProtocol) (err error) {
	if err := oprot.WriteFieldBegin("clientArguments", thrift.LIST, 10); err != nil {
		return fmt.Errorf("%T write field begin error 10:clientArguments: %s", p, err)
	}
	...
	if err := oprot.WriteFieldEnd(); err != nil {
		return fmt.Errorf("%T write field end error 10:clientArguments: %s", p, err)
	}
	return err
}

func (p *ExecutorTaskInfoHelper) writeField11(oprot thrift.TProtocol) (err error) {
	if err := oprot.WriteFieldBegin("environmentExtra", thrift.LIST, 11); err != nil {
		return fmt.Errorf("%T write field begin error 11:environmentExtra: %s", p, err)
	}
	...
	if err := oprot.WriteFieldEnd(); err != nil {
		return fmt.Errorf("%T write field end error 11:environmentExtra: %s", p, err)
	}
	return err
}

func (p *ExecutorTaskInfoHelper) writeField12(oprot thrift.TProtocol) (err error) {
	if err := oprot.WriteFieldBegin("dockerContainer", thrift.STRING, 12); err != nil {
		return fmt.Errorf("%T write field begin error 12:dockerContainer: %s", p, err)
	}
	if err := oprot.WriteString(string(p.DockerContainer)); err != nil {
		return fmt.Errorf("%T.dockerContainer (12) field write error: %s", p, err)
	}
	if err := oprot.WriteFieldEnd(); err != nil {
		return fmt.Errorf("%T write field end error 12:dockerContainer: %s", p, err)
	}
	return err
}

func (p *ExecutorTaskInfoHelper) writeField13(oprot thrift.TProtocol) (err error) {
	if err := oprot.WriteFieldBegin("retries", thrift.I32, 13); err != nil {
		return fmt.Errorf("%T write field begin error 13:retries: %s", p, err)
	}
	if err := oprot.WriteI32(int32(p.Retries)); err != nil {
		return fmt.Errorf("%T.retries (13) field write error: %s", p, err)
	}
	if err := oprot.WriteFieldEnd(); err != nil {
		return fmt.Errorf("%T write field end error 13:retries: %s", p, err)
	}
	return err
}

func (p *ExecutorTaskInfoHelper) writeField14(oprot thrift.TProtocol) (err error) {
	if err := oprot.WriteFieldBegin("router", thrift.STRUCT, 14); err != nil {
		return fmt.Errorf("%T write field begin error 14:router: %s", p, err)
	}
	if err := p.Router.Write(oprot); err != nil {
		return fmt.Errorf("%T error writing struct: %s", p.Router, err)
	}
	if err := oprot.WriteFieldEnd(); err != nil {
		return fmt.Errorf("%T write field end error 14:router: %s", p, err)
	}
	return err
}
...
type PhysicalComputationMetadata struct {
	...
	Killed              bool                    `thrift:"killed,8" json:"killed"`
}
...
func (p *PhysicalComputationMetadata) GetKilled() bool {
	return p.Killed
}
...
func (p *PhysicalComputationMetadata) ReadField8(iprot thrift.TProtocol) error {
	if v, err := iprot.ReadBool(); err != nil {
		return fmt.Errorf("error reading field 8: %s", err)
	} else {
		p.Killed = v
...
func (p *PhysicalComputationMetadata) writeField8(oprot thrift.TProtocol) (err error) {
	if err := oprot.WriteFieldBegin("killed", thrift.BOOL, 8); err != nil {
		return fmt.Errorf("%T write field begin error 8:killed: %s", p, err)
	}
	if err := oprot.WriteBool(bool(p.Killed)); err != nil {
		return fmt.Errorf("%T.killed (8) field write error: %s", p, err)
	}
	if err := oprot.WriteFieldEnd(); err != nil {
		return fmt.Errorf("%T write field end error 8:killed: %s", p, err)
	}
	return err
}
...
type TopologyMetadata struct {
	...
	KafkaBrokerList string                                `thrift:"kafkaBrokerList,4" json:"kafkaBrokerList"`
}
...
func (p *TopologyMetadata) GetKafkaBrokerList() string {
	return p.KafkaBrokerList
}
...
func (p *TopologyMetadata) ReadField4(iprot thrift.TProtocol) error {
	if v, err := iprot.ReadString(); err != nil {
		return fmt.Errorf("error reading field 4: %s", err)
	} else {
		p.KafkaBrokerList = v
...
func (p *TopologyMetadata) writeField4(oprot thrift.TProtocol) (err error) {
	if err := oprot.WriteFieldBegin("kafkaBrokerList", thrift.STRING, 4); err != nil {
		return fmt.Errorf("%T write field begin error 4:kafkaBrokerList: %s", p, err)
	}
	if err := oprot.WriteString(string(p.KafkaBrokerList)); err != nil {
		return fmt.Errorf("%T.kafkaBrokerList (4) field write error: %s", p, err)
	}
	if err := oprot.WriteFieldEnd(); err != nil {
		return fmt.Errorf("%T write field end error 4:kafkaBrokerList: %s", p, err)
	}
	return err
}
...
type BoltComputationRequest struct {
	...
	ForcePullContainer bool                    `thrift:"forcePullContainer,9" json:"forcePullContainer"`
}
...
func (p *BoltComputationRequest) GetForcePullContainer() bool {
	return p.ForcePullContainer
}
...
func (p *BoltComputationRequest) ReadField9(iprot thrift.TProtocol) error {
	if v, err := iprot.ReadBool(); err != nil {
		return fmt.Errorf("error reading field 9: %s", err)
	} else {
		p.ForcePullContainer = v
	}
	return nil
}
...
func (p *BoltComputationRequest) writeField9(oprot thrift.TProtocol) (err error) {
	if err := oprot.WriteFieldBegin("forcePullContainer", thrift.BOOL, 9); err != nil {
		return fmt.Errorf("%T write field begin error 9:forcePullContainer: %s", p, err)
	}
	if err := oprot.WriteBool(bool(p.ForcePullContainer)); err != nil {
		return fmt.Errorf("%T.forcePullContainer (9) field write error: %s", p, err)
	}
	if err := oprot.WriteFieldEnd(); err != nil {
		return fmt.Errorf("%T write field end error 9:forcePullContainer: %s", p, err)
	}
	return err
}
