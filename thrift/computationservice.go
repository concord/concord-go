...
func (p *ComputationServiceClient) Destroy() (err error) {
...
func (p *ComputationServiceClient) sendDestroy() (err error) {
	oprot := p.OutputProtocol
	if oprot == nil {
		oprot = p.ProtocolFactory.GetProtocol(p.Transport)
		p.OutputProtocol = oprot
...
func (p *ComputationServiceClient) recvDestroy() (err error) {
	iprot := p.InputProtocol
	if iprot == nil {
		iprot = p.ProtocolFactory.GetProtocol(p.Transport)
		p.InputProtocol = iprot
...
func NewComputationServiceProcessor(handler ComputationService) *ComputationServiceProcessor {
	...
	self41 := &ComputationServiceProcessor{handler: handler, processorMap: make(map[string]thrift.TProcessorFunction)}
	self41.processorMap["init"] = &computationServiceProcessorInit{handler: handler}
	self41.processorMap["destroy"] = &computationServiceProcessorDestroy{handler: handler}
	self41.processorMap["boltProcessRecords"] = &computationServiceProcessorBoltProcessRecords{handler: handler}
	self41.processorMap["boltProcessTimer"] = &computationServiceProcessorBoltProcessTimer{handler: handler}
	self41.processorMap["boltMetadata"] = &computationServiceProcessorBoltMetadata{handler: handler}
	return self41
}
...
func (p *computationServiceProcessorInit) Process(seqId int32, iprot, oprot thrift.TProtocol) (success bool, err thrift.TException) {
	...
	iprot.ReadMessageEnd()
	result := InitResult{}
	var retval *ComputationTx
	var err2 error
	if retval, err2 = p.handler.Init(); err2 != nil {
		switch v := err2.(type) {
		case *BoltError:
			result.E = v
		default:
...
type computationServiceProcessorDestroy struct {
	handler ComputationService
}

func (p *computationServiceProcessorDestroy) Process(seqId int32, iprot, oprot thrift.TProtocol) (success bool, err thrift.TException) {
	args := DestroyArgs{}
	if err = args.Read(iprot); err != nil {
		iprot.ReadMessageEnd()
		x := thrift.NewTApplicationException(thrift.PROTOCOL_ERROR, err.Error())
...
func (p *computationServiceProcessorBoltProcessRecords) Process(seqId int32, iprot, oprot thrift.TProtocol) (success bool, err thrift.TException) {
	...
	var retval []*ComputationTx
	var err2 error
	if retval, err2 = p.handler.BoltProcessRecords(args.Records); err2 != nil {
		switch v := err2.(type) {
		case *BoltError:
			result.E = v
		default:
...
func (p *computationServiceProcessorBoltProcessTimer) Process(seqId int32, iprot, oprot thrift.TProtocol) (success bool, err thrift.TException) {
	...
	var retval *ComputationTx
	var err2 error
	if retval, err2 = p.handler.BoltProcessTimer(args.Key, args.Time); err2 != nil {
		switch v := err2.(type) {
		case *BoltError:
			result.E = v
		default:
...
var DestroyResult_E_DEFAULT *BoltError

func (p *DestroyResult) GetE() *BoltError {
	if !p.IsSetE() {
		return DestroyResult_E_DEFAULT
	}
	return p.E
}
func (p *DestroyResult) IsSetE() bool {
	return p.E != nil
}
...
func (p *DestroyResult) ReadField1(iprot thrift.TProtocol) error {
	p.E = &BoltError{}
	if err := p.E.Read(iprot); err != nil {
		return fmt.Errorf("%T error reading struct: %s", p.E, err)
	}
...
func (p *DestroyResult) writeField1(oprot thrift.TProtocol) (err error) {
	if p.IsSetE() {
		if err := oprot.WriteFieldBegin("e", thrift.STRUCT, 1); err != nil {
			return fmt.Errorf("%T write field begin error 1:e: %s", p, err)
		}
